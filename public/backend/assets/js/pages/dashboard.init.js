var options = {
        chart: { height: 380, type: "bar", stacked: !0, toolbar: { show: !1 }, zoom: { enabled: !0 } },
...
(chart = new ApexCharts(document.querySelector("#list-chart-2"), options)).render(),
    $("#world-map-markers").vectorMap({
        ...
        markerStyle: { initial: { r: 9, fill: "#525CE9", "fill-opacity": 0.9, stroke: "#fff", "stroke-width": 7, "stroke-opacity": 0.4 }, hover: { stroke: "#fff", "fill-opacity": 1, "stroke-width": 1.5 } },
